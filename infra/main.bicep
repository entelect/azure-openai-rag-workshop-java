...
param qdrantImageName string = 'docker.io/qdrant/qdrant:v1.12.4'
...
module openAiRoleIngestionApi 'core/security/role.bicep' = {
  scope: openAiResourceGroup
...
output AZURE_OPENAI_URL string = openAiUrl
